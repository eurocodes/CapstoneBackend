...
const commentUrl = '/api/v1/articles/post/comments/39';
const notFoundUrl = '/api/v1/articles/post/comments/2';
const deleteUrl = '/api/v1/articles/comments/delete/30';
const adminDelete = '/api/v1/articles/comments/delete/31';
const unAuthDelete = '/api/v1/articles/comments/delete/32';
...
describe('Test comment Article', () => {
  ...
  it('Should successfully comment on a given post', (done) => {
    request(app).post(commentUrl).set('x-access-token', token)
      .send({ comment: 'Nice one, thumbs up' })
      .then((res) => {
  ...
  it('Should fail to comment, "Article not found"', (done) => {
